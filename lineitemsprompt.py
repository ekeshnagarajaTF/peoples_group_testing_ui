...
line = f'''Extract the following items from the provided financialDocument:

Document content:
{data}.

Extract **all revenue and expense line items** from the document using the synonyms below.
1. Total revenue:
...
4. Revenue Items:
Extract any item in the document that represents revenue using this synonyms list:
  - Total Revenue
  - Rental Income
  - Lease Revenue
  - Rent Revenue
...
5. Expense Items:
Extract any item in the document that represents an expense using this items header synonyms list:
  - Expense
  - Expenses
...
{{
  ...
  "revenueItems": [
    {{
      "value": ["revenue_item1_name": "value", "revenue_item2_name" : "value", ....],
      "status": "",
      "reason": ""
    }}
  ],
  "expenseItems": [
    {{
      "value": ["expense_item1_name": "value", "expense_item2_name" : "value", ....],
      "status": "",
      "reason": ""
    }}
  ]
...
Total revenue object with value, status, and reason
Total expense object with value, status, and reason
Net operating income object with value, status, and reason
revenueItems array of extracted revenue items with item_names and values, status of revenueItems and reason of Extraction for revnueItems.
expenseItems array of extracted expense items with item_names and values, status of expenseItems and reason of Extraction for expenseItems.'''
